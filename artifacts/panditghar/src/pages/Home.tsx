      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-12 pb-24">
          ...
          >
            ...
            <p className={`text-xl md:text-2xl text-white/90 mb-10 leading-relaxed ${isHi ? 'font-hindi' : ''}`}>
              {t.hero.subtitle}
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.slice(0, 6).map((service, index) => (
            <motion.div 
              ...
              className="bg-card rounded-2xl overflow-hidden border border-border shadow-lg hover:shadow-xl hover:border-accent/50 transition-all duration-300 group flex flex-col"
            >
      ...
      <section className="py-20 bg-gradient-maroon text-white relative overflow-hidden my-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 w-full relative">
            <div className="aspect-square max-w-md mx-auto rounded-full overflow-hidden border-4 border-accent/50 shadow-glow-gold relative">
              <img 
