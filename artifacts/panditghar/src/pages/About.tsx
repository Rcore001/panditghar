...
import { CheckCircle2, Award, MapPin, Phone } from 'lucide-react';
    ...
    <div className="pt-24 pb-16">
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="aspect-square max-w-sm mx-auto rounded-2xl overflow-hidden border-4 border-primary/30 shadow-xl">
              <img
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {services_areas.map(area => (
            <span key={area} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-primary/10 text-primary font-medium border border-primary/20">
